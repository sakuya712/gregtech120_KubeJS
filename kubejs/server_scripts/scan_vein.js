ServerEvents.recipes(event => {
    ...
    veins.forEach((vein) => {
        let crate = greg.scan_vein(`${vein[0]}_vein`)
        crate.itemInputs('gtceu:data_stick');
        vein[1].forEach((ore) => {
            crate.itemInputs(`5x #forge:ores/${ore[0]}`)
        });
        crate.itemOutputs(`kubejs:vein_data_${vein[0]}`)
            .duration(6000)
            .EUt(20);
    });
})